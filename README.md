...
5. 「キーフレーム操作」欄の「取得」ボタンをクリックして、現在位置のキーフレームを子孫レイヤも含めて全て取得します。さらに一括シフト機能を利用する場合は、`Shift`キーを押しながらクリックすると以降のキーフレームも一括で取得します。
...
4. 字幕を反映させたい音声レイヤを選択し、「テキストを反映」ボタンをクリックします。
